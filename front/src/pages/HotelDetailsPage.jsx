...
import { ChevronLeft, Star, Heart, Check, ImageOff, ChevronRight, ArrowRight, Minus, Plus, Calculator, Bell, Share2, MapPin, Wifi, Car, Waves, Coffee, Wind, RotateCcw, Zap } from 'lucide-react';
...
const HotelDetailsPage = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      // Check price alert subscription status
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-[#141414] border border-[#E5E5E5] dark:border-[#262626] rounded-card overflow-hidden">
            ...
            <div className="p-6 space-y-4">
                      ...
                      {hotel.reviews.map((rev) => (
                        <div key={rev.id} className="p-4 border border-[#E5E5E5] dark:border-[#262626] bg-[#FAFAFA] dark:bg-[#0A0A0A] space-y-1">
                          <div className="flex items-center justify-between text-xs">
                            <div className="flex items-center gap-2">
                              <div className="w-5 h-5 rounded-full bg-[#E5E5E5] dark:bg-[#262626] font-bold text-[10px] flex items-center justify-center">
                          ...
                          <p className="text-xs text-[#8A8A8A] pt-1 italic">"{rev.comment}"</p>
                        </div>
                      ))}
                    </div>
                  ) : (
              ...
              {/* Tab Content 4: Location & What's Nearby */}
              {activeTab === 'location' && (
                <div className="pt-4 space-y-4 animate-fade-in">
